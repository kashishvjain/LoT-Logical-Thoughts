...
def main(args):
    ...
    if args.env == "cot":
        env = CoTEnv(
            ...
            output=f"{args.output}/{args.dataset_name}/outputs/output_dev_{args.model_name}_cot.jsonl",
        ...
        env = LogiCoTEnv(
            ...
            output=f"{args.output}/{args.dataset_name}/outputs/output_dev_{args.model_name}_lot.jsonl",
            prompt_version=args.prompt_version,
            debug=args.debug,
        )
        agent = LogiAgent(
